    ...
    return (
        <React.Fragment>
            <div className="h-screen overflow-hidden">
                <NavBar />
                <div className="homeContent mx-5 flex flex-col md:flex-row items-center justify-center md:justify-between h-[110%] md:h-[115%] sm:h-[110%] mt-[100px] md:mt-0">
                    ...
                    <div className="mt-8 md:mt-0">
                        <img src={meImage} alt="me" className="me scale-125 mx-auto md:mx-0" />
                    </div>
                </div>
            </div>
        </React.Fragment>
